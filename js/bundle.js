...
},{"./app.js":2,"jquery":3,"object-fit-images":4}],2:[function(require,module,exports){
...
$(document).ready(function () {
    var headerSlider = $('.header-slider'),
            ...
            gallerySlider = $('.galery-slider'),
            contactBlock = $('.contact-block--item');

    function initBxSlider(object, param) {
        ...
        object = object.bxSlider(param);
        return object;
    }

    $('.close,.popupoverlay').click(function () {
        $('.registration-popup,.common-popup').closePopUp();
    })


    $('.jsregbutton').click(function (e) {
        e.preventDefault();
        $('.registration-popup').openPopUp();
    })
    $('.jscommonbutton').click(function (e) {
        e.preventDefault();
        $('.common-popup').openPopUp();
    });

    $('.rbutton li').click(function () {
        $('.rbutton li').removeClass('active');
        $(this).addClass('active');
        var index = $(this).index();
        $('.rtab li').removeClass('active').eq(index).addClass('active');
    })

    objectFitImages();
    $('.scroll-item-head').click(function () {
        if ($(this).closest('.scroll-item').find('.scroll-item-body').length !== 0)
            $(this).closest('.scroll-item').find('.scroll-item-body').slideToggle(600);
    })
